...
if (! function_exists('form_create_input')) {
    ...
    function form_create_input($args1,$args2,$args3,$args4)
    {
        ...
        if($args4 == 4 && $args1['name'] == 'wallet_address'){
        ...
        if($args1['name'] == 'name'){
            $output.='<p class="help-block">* Legal Name shown on your ID or Passport</p>';
        }else if($args1['name'] == 'wallet_address'){
            $output.='<p class="help-block">* Do not use a third party managed wallet</p>';
        }
        $output.="</div></div>";
        return $output;
...
if (! function_exists('form_create_textarea')) {
    ...
    function form_create_textarea($args1,$args2,$args3)
    {
        ...
        if($args1['name'] == 'address'){
            $output.='<p class="help-block">* Resident address</p>';
        }
        $output.="</div></div>";
        return $output;
        //return "<br/><input type='text' value='' />";
...
if (! function_exists('form_proff_pic'))
{
    ...
    function form_proff_pic($args1,$args2,$args3)
    {
        ...
        $nota = 'dove_dash_preview_error.png';
        $notaupd = 'dove_dash_doc_error.png';
        $err_class = form_error($args1['name']) ? 'has-error' : '';
        $err_class1 = isset($message)? $message:'';
        $err_class2 = form_error($args1['name'])? form_error($args1['name']) : '';
        $image = ($args2!='')?
        ...
        $output.="<div class='help-inline'>jpg,png,gif,jpeg,pdf file type allowed. Max Size:5MB.</div>";
            $output .="<div>
                                <span class='btn default btn-file'>
                                    <span class='fileinput-new'>Select image </span>
                                    <span class='fileinput-exists'>Change </span>
                            ...
                            <p class='help-block'>* Must show your legal name</p>
                            <span class='error'>$err_class1</span>
                            <span class='help-inline'>$err_class2</span></br>";
        ...
        $output.="<div class='controls'>
                    ...
                    <!--<div class='fileinput-preview fileinput-exists thumbnail' style='max-width: 200px; max-height: 150px;'></div>-->
                        ...
                        <span class='btn default btn-file'>
                                 ...
                                 <p class='help-block'>* Must contain your legal name</p>
                                    <span class='error'>$err_class1</span>
                                    <span class='help-inline'>$err_class2</span></br>
                                </div>
                                </div>
