...
<?php endif; ?>
<div class='admin-box portlet box blue'>
    <div class='portlet-title'>
        <div class='caption'>
            <i class='fa fa-pencil'></i> Create Role
        </div>
    </div>
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('role_name') ? ' has-error' : ''; ?>">
                <label class="control-label col-md-3" for="role_name"><?php echo lang('role_name'); ?></label>
                <div class="controls">
                    <input type="text" name="role_name" id="role_name" class="input-xlarge form-control" value="<?php echo set_value('role_name', isset($role) ? $role->role_name : ''); ?>" />
                    <span class="help-inline"><?php echo form_error('role_name'); ?></span>
                </div>
            </div>
            <div class="description control-group<?php echo form_error('description') ? ' has-error' : ''; ?>">
                <label class="control-label col-md-3" for="description"><?php echo lang('bf_description'); ?></label>
                <div class="controls">
                    <textarea name="description" id="description" rows="3" class="input-xlarge form-control"><?php echo set_value('description', isset($role) ? $role->description : ''); ?></textarea>
                    <span class="help-inline"><?php echo form_error('description') ? form_error('description') : lang('role_max_desc_length'); ?></span>
                </div>
            </div>
            <div class="control-group<?php echo form_error('login_destination') ? ' has-error' : ''; ?>">
                <label class="control-label col-md-3" for="login_destination"><?php echo lang('role_login_destination'); ?></label>
                <div class="controls">
                    <input type="text" name="login_destination" id="login_destination" class="input-xlarge form-control" value="<?php echo set_value('login_destination', isset($role) ? $role->login_destination : ''); ?>" />
            ...
            <div class="control-group">
                <label class="control-label col-md-3" for="default_context"><?php echo lang('role_default_context'); ?></label>
                <div class="controls">
                    <select name="default_context"  class="input-xlarge form-control" id="default_context">
                        <?php
            ...
            <div class="control-group<?php echo form_error('default') ? ' error' : ''; ?>">
                <label class="control-label col-md-3" for="default"><?php echo lang('role_default_role'); ?></label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label col-md-3" id="can_delete_label"><?php echo lang('role_can_delete_role'); ?></label>
        ...
        <fieldset class="form-actions">
            <input type="submit" name="save" class="btn blue" value="<?php echo lang('role_save_role'); ?>" />
            <?php
            echo lang('bf_or') . ' ' . anchor(SITE_AREA . '/settings/roles', lang('bf_action_cancel'),"class='btn default'");
