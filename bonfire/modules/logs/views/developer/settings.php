	...
	<?php echo form_open(site_url(SITE_AREA . '/developer/logs/enable'), 'class="form-horizontal"'); ?>
        <fieldset>
            <div class="control-group">
                <label for="log_threshold" class="control-label col-md-3"><?php echo lang('logs_the_following'); ?></label>
                <div class="controls">
                    <select name="log_threshold" class="form-control input-medium" id="log_threshold">
