		...
		<table class="table table-striped table-bordered table-hover dataTable no-footer">
			<thead>
				<tr>
                    ...
                    <th width="47%"><?php echo lang('database_table_name'); ?></th>
                    <th class='records'><?php echo lang('database_num_records'); ?></th>
                    <th width="10%"><?php echo lang('database_data_size'); ?></th>
                    <th width="10%"><?php echo lang('database_index_size'); ?></th>
                    <th width="10%"><?php echo lang('database_data_free'); ?></th>
                    <th width="10%"><?php echo lang('database_engine'); ?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
					<td colspan="7">
                        <table>
                        <td><label class="col-md-3" for='database-action'><?php echo lang('bf_with_selected'); ?>:</label>
                            <select name="action" id='database-action' class="span2 form-control input-medium">
                            ...
                            <td>
                            <input type="submit"  value="<?php echo lang('database_apply')?>" class="btn green" />
					</td>
                        </table>
                            </td>
				</tr>
