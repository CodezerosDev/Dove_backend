    ...
    ?>
		...
		<div class="alert alert-info">
            ...
            <div class="control-group<?php echo form_error('file_name') ? ' error' : ''; ?>">
                <label for="file_name" class="control-label col-md-3"><?php echo lang('database_filename'); ?></label>
			<div class="controls">
                    <input type="text" name="file_name" class="form-control input-medium" id="file_name" value="<?php echo set_value('file_name', empty($file) ? '' : $file); ?>" />
                    <span class="help-inline"><?php echo form_error('file_name'); ?></span>
			</div>
		</div>
            <div class="control-group<?php echo form_error('drop_tables') ? ' error' : ''; ?>">
                <label for="drop_tables" class="control-label col-md-3"><?php echo lang('database_drop_question'); ?></label>
			<div class="controls">
				<select name="drop_tables" class="form-control input-medium" id="drop_tables">
            ...
            <div class="control-group<?php echo form_error('add_inserts') ? ' error' : ''; ?>">
                <label for="add_inserts" class="control-label col-md-3"><?php echo lang('database_insert_question'); ?></label>
			<div class="controls">
				<select name="add_inserts" class="form-control input-medium" id="add_inserts">
            ...
            <div class="control-group<?php echo form_error('file_type') ? ' error' : ''; ?>">
                <label for="file_type" class="control-label col-md-3"><?php echo lang('database_compress_question'); ?></label>
			<div class="controls">
				<select name="file_type" class="form-control input-medium" id="file_type">
		...
		<fieldset class="form-actions">
			<button type="submit" name="backup" class="btn green"><?php echo lang('database_backup'); ?></button>
            <?php echo ' ' . lang('bf_or') . ' ' . anchor(SITE_AREA . '/developer/database', lang('bf_action_cancel'),'class="btn default"'); ?>
		</fieldset>
	<?php
        echo form_close();
    endif;
