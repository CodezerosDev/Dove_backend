...
<div class="admin-box">
	<div class="row">
		<div class="column size1of3 col-md-2">
			<p><strong><?php echo lang('em_total_in_queue'); ?></strong> <?php echo $total_in_queue ? $total_in_queue : '0' ?></p>
		</div>
		<div class="column size1of3 col-md-5">
			<p><strong><?php echo lang('em_total_sent'); ?></strong> <?php echo $total_sent ? $total_sent : '0' ?></p>
		</div>
		<div class="column size1of3  col-md-6 text-right">
			<?php echo form_open($this->uri->uri_string(), array('class' => 'form-inline')); ?>
				<input type="submit" name="force_process" class="btn purple" value="<?php e(lang('em_force_process')); ?>" />
				<input type="submit" name="insert_test" class="btn default" value="<?php e(lang('em_insert_test')); ?>" />
			<?php echo form_close(); ?>
		</div>
	</div>
	<?php
