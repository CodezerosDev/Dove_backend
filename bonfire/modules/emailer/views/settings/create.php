		...
		<table class="table">
			<tbody>
				<tr>
					...
					<td><input type="text" class="form-control input-medium"size="50" name="email_subject" id="email_subject" value="<?php if (isset($email_subject)) { e($email_subject); } ?>"></td>
				</tr>
				<tr>
					<td class="col-md-3">Content:</td>
					<td>
						<textarea name="email_content" class="form-control input-xl" id="email_content" rows="15"><?php
			...
			<tfoot>
				<tr>
					<td colspan="<?php echo $num_users_columns; ?>">
						...
						<input type="submit" name="create" class="btn purple" value="<?php echo lang('em_create_email') ?>">
						<?php echo anchor(SITE_AREA . '/settings/emailer/queue', lang('bf_action_cancel'), 'class="btn default"'); ?>
					</td>
				</tr>
			</tfoot>
			<tbody>
