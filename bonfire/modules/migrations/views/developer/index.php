		...
		<div class="tab-pane active" id="app-tab">
            <?php echo form_open($this->uri->uri_string(), 'class="constrained"'); ?>
    			<fieldset>
					...
					<label class='control-label col-md-3' for='app_migration'><?php echo lang('migrations_choose_migration'); ?></label>
                    <select name="migration" class="form-control input-medium" id='app_migration'>
				...
				<fieldset class="form-actions">
					<input type="submit" name="migrate" class="btn green" value="<?php echo lang('migrations_migrate_button'); ?>" />
                    <?php
                        echo ' ' . lang('bf_or') . ' ' . anchor(SITE_AREA . '/developer/migrations', lang('bf_action_cancel'),'class="btn default"');
                    else :
                    ?>
			...
			<fieldset>
                ...
                <table class="table table-striped table-bordered table-hover dataTable no-footer">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="col-md-3"><?php echo ucfirst($module); ?></td>
                            <td class="col-md-3"><?php echo $migrations['installed_version']; ?></td>
                            <td class="col-md-3"><?php echo $migrations['latest_version']; ?></td>
                            <td class='migrate'>
                                <table>
                                <?php echo form_open(site_url(SITE_AREA . "/developer/migrations/migrate_module/{$module}"), 'class="form-horizontal"'); ?>
                                 ...
                                 <td>   <select class="form-control input-medium" name="version">
                                    ...
                                    <td><input type="submit" name="migrate" class="btn green " value="<?php echo lang('migrations_migrate_module'); ?>" />
                                </td>
                                        <?php echo form_close(); ?>
                                    </table>
                            </td>
            ...
            <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
                <fieldset>
					...
					<div class="control-group">
						<label class="control-label col-md-3" for="migration"><?php echo lang('migrations_choose_migration'); ?></label>
						<div class="controls">
							<select name="migration" class="form-control input-medium" id="migration">
                                <option value=""></option>
