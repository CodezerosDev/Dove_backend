    ...
    foreach ($meta_fields as $field) :
        ...
        elseif ($field['form_detail']['type'] == 'country_select' && is_callable('country_select')) :
            ...
            <div class="control-group <?php echo iif( form_error('country') , 'has-error'); ?>">
                ...
                <div class="controls">
                    <?php echo country_select(set_value($field['name'], isset($user->$field['name']) ? $user->$field['name'] : $defaultCountry), $defaultCountry, 'country', 'chzn-select form-control input-medium'); ?>
                </div>
            </div>
            <?php
        else:
