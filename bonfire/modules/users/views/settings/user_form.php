...
?>
    ...
    <div class='portlet-title'>
        <div class='caption'>
            <i class='fa fa-pencil'></i> <?php echo lang('us_account_details') ?>
        </div>
    </div>
...
?>
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select name="role_id" id="role_id" class="chzn-select <?php echo $controlClass; ?> form-control input-medium">
                    <?php
    ...
    <div class="form-actions">
        <input type="submit" name="save" class="btn green" value="<?php echo lang('bf_action_save') . ' ' . lang('bf_user'); ?>" />
        <?php echo lang('bf_or'); ?>
        <?php echo anchor(SITE_AREA . '/settings/users', lang('bf_action_cancel'), 'class="btn default"'); ?>
    </div>
<?php echo form_close(); ?>