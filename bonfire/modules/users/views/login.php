...
?>
<p><br/><a href="http://dove.network">&larr; <?php echo lang('us_back_to') . $this->settings_lib->item('site.title'); ?></a></p>

<center><a href="https://dove.network/"><img src="<?=base_url();?>/assets/images/_logo_3.png"></a></center>
