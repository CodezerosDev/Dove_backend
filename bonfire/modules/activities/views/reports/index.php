            ...
            <tr>
                <?php echo form_open("{$activitiesReportsPage}/delete", array('id' => 'activity_own_form', 'class' => 'form-inline')); ?>
                    ...
                    <td>
                        ...
                        <select name="which" class="table-group-action-input form-control input-medium" id="activity_own_select">
            ...
            <tr>
                <?php echo form_open("{$activitiesReportsPage}/delete", array('id' => 'activity_user_form', 'class' => 'form-inline')); ?>
                    ...
                    <td>
                        ...
                        <select name="which" class="table-group-action-input form-control input-medium" id="activity_user_select">
			...
			<tr>
                <?php echo form_open("{$activitiesReportsPage}/delete", array('id' => 'activity_module_form', 'class' => 'form-inline')); ?>
                    ...
                    <td>
                        ...
                        <select name="which" class="table-group-action-input form-control input-medium" id="activity_module_select">
			...
			<tr>
                <?php echo form_open("{$activitiesReportsPage}/delete", array('id' => 'activity_date_form', 'class' => 'form-inline')); ?>
                    ...
                    <td>
                        ...
                        <select name="which" class="table-group-action-input form-control input-medium" id="activity_date_select">
