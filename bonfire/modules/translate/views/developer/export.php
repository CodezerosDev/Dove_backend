    ...
    <?php echo form_open(current_url(), 'class="form-horizontal"'); ?>
        <fieldset>
            <div class="control-group">
                <label for="export_lang" class="control-label col-md-3"><?php echo lang('tr_language'); ?></label>
                <div class="controls">
                    <select name="export_lang" class="form-control input-medium" id="export_lang">
            ...
            <div class="control-group">
                <label class="control-label col-md-3"><?php echo lang('tr_include'); ?></label>
                <div class="controls">
        ...
        <fieldset class="form-actions">
            <input type="submit" name="export" class="btn green" value="<?php e(lang('tr_export_short')); ?>" />
        </fieldset>
    <?php echo form_close(); ?>
</div>