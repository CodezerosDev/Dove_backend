    ...
    <div class="admin-box">
        ...
        ?>
            ...
            <fieldset id="db_details">
                ...
                <div class="control-group mb_advanced <?php echo form_error('status_field') ? 'error' : ''; ?>">
                    <label for="status_field" class="control-label block"><?php echo lang('mb_form_status_field'); ?></label>
                    <div class="controls">
                        <input name="status_field" id="status_field" type="text" value="<?php echo set_value("status_field", "status"); ?>" />
                ...
                <div class="control-group mb_advanced">
                    ...
                    <div class="controls">
                        <select name="use_position" id="use_position">
                            <?php foreach ($truefalse as $val => $label): ?>
                                <option value="<?php echo $val ?>"><?php echo $label ?></option>
                            <?php                   endforeach; ?>
                        </select>
                ...
                <div class="control-group mb_advanced <?php echo form_error('position_field') ? 'error' : ''; ?>">
                    <label for="position_field" class="control-label block"><?php echo lang('mb_form_position_field'); ?></label>
                    <div class="controls">
                        <input name="position_field" id="position_field" type="text" value="<?php echo set_value("position_field", "position"); ?>" />
            ...
            <div id="all_fields">
                ...
                <fieldset id="field<?php echo $count; ?>_details">
                    ...
                    <div style="margin-left: 10px;">
                        ...
                        <div class="control-group">
                            <label class="control-label" for=""><?php echo lang('grid_form_search_label'); ?></label>
                            <div class="controls">
                                <input name="grid_search[]" type="checkbox" value="view_field_name<?php echo $count; ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for=""><?php echo lang('grid_form_sort_label'); ?></label>
                            <div class="controls">
                                <input name="grid_sort[]" type="checkbox" value="view_field_name<?php echo $count; ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for=""><?php echo lang('grid_form_between_label'); ?></label>
                            <div class="controls">
