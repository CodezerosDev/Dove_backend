...
<div class='admin-box portlet box green'>
    <div class='portlet-title'>
        <div class='caption'>
            <i class='glyphicon glyphicon-wrench'></i> Site Settings
        </div>
    </div>
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<div class="tabbable">
			<ul class="nav nav-tabs">
                ...
                <?php endif; ?>
                <li>
                    <a href="#meta-settings" data-toggle="tab"><?php echo lang('set_tab_meta'); ?></a>
                </li>
                <li>
                    <a href="#footer-script" data-toggle="tab"><?php echo lang('set_tab_footer'); ?></a>
                </li>

                <li>
                    <a href="#header-script" data-toggle="tab"><?php echo lang('set_tab_header'); ?></a>
                </li>
			</ul>
			<div class="tab-content main-settings">
				...
				<div class="tab-pane active" id="main-settings">
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label col-md-3" for="title"><?php echo lang('bf_site_name'); ?></label>
							<div class="controls">
								<input type="text" name="title" id="title" class="form-control input-medium" value="<?php echo set_value('site.title', isset($settings['site.title']) ? $settings['site.title'] : ''); ?>" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label col-md-3" for="system_email"><?php echo lang('bf_site_email'); ?></label>
							<div class="controls">
								<input type="text" name="system_email" id="system_email" class="form-control input-medium" value="<?php echo set_value('site.system_email', isset($settings['site.system_email']) ? $settings['site.system_email'] : ''); ?>" />
								<span class="help-inline"><?php echo lang('bf_site_email_help'); ?></span>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label col-md-3"  for="status"><?php echo lang('bf_site_status'); ?></label>
							<div class="controls">
						...
						<div class="control-group">
							<label class="control-label col-md-3" for="list_limit"><?php echo lang('bf_top_number'); ?></label>
							<div class="controls">
								<input type="text" name="list_limit" id="list_limit" value="<?php echo set_value('list_limit', isset($settings['site.list_limit']) ? $settings['site.list_limit'] : ''); ?>" class="form-control input-medium" />
								<span class="help-inline"><?php echo lang('bf_top_number_help'); ?></span>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label col-md-3" for="languages"><?php echo lang('bf_language'); ?></label>
							<div class="controls">
								<select name="languages[]" class=" form-control input-medium" id="languages" multiple="multiple">
                                    <?php
				...
				<div class="tab-pane" id="security">
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label col-md-3" for="user_activation_method"><?php echo lang('bf_activate_method'); ?></label>
							<div class="controls">
								<select name="user_activation_method" class=" form-control input-medium" id="user_activation_method">
						...
						<div class="control-group">
							<label class="control-label col-md-3" for="login_type"><?php echo lang('bf_login_type') ?></label>
							<div class="controls">
								<select name="login_type" class=" form-control input-medium" id="login_type">
                        ...
                        <div class="control-group">
							<label class="control-label col-md-3" id="use_usernames_label"><?php echo lang('bf_use_usernames'); ?></label>
						...
						<div class="control-group">
							<label class="control-label col-md-3" id='allow_name_change_label'><?php echo lang('bf_display_name'); ?></label>
							<div class="controls" aria-labelledby='allow_name_change_label' role='group'>
								...
								<div id="name-change-settings" style="<?php if ( ! $settings['auth.allow_name_change']) { echo 'display: none'; } ?>">
									<input type="text" class=" form-control input-medium" name="name_change_frequency" value="<?php echo set_value('auth.name_change_frequency', isset($settings['auth.name_change_frequency']) ? $settings['auth.name_change_frequency'] : ''); ?>" />
									<?php echo lang('set_name_change_frequency'); ?>
									<input type="text" class=" form-control input-medium" name="name_change_limit" value="<?php echo set_value('auth.name_change_limit', isset($settings['auth.name_change_limit']) ? $settings['auth.name_change_limit'] : ''); ?>" />
						...
						<div class="control-group" id="remember-length" style="<?php if ( ! $settings['auth.allow_remember']) { echo 'display: none'; } ?>">
							<label class="control-label col-md-3" for="remember_length"><?php echo lang('bf_remember_time'); ?></label>
							<div class="controls">
								<select name="remember_length" class=" form-control input-medium" id="remember_length">
						...
						<div class="control-group" id="password-strength">
							<label class="control-label col-md-3" for="password_min_length"><?php echo lang('bf_password_strength'); ?></label>
							<div class="controls">
								<input type="text" name="password_min_length" id="password_min_length" value="<?php echo set_value('password_min_length', isset($settings['auth.password_min_length']) ? $settings['auth.password_min_length'] : ''); ?>" class="span1 form-control input-medium" />
								<span class="help-inline"><?php echo lang('bf_password_length_help'); ?></span>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label col-md-3" id='password_options_label'><?php echo lang('set_option_password'); ?></label>
						...
						<div class="control-group">
							<label for="password_iterations" class="control-label col-md-3 "><?php echo lang('set_password_iterations'); ?></label>
							<div class="controls">
								<select name="password_iterations" class=" form-control input-medium" id='password_iterations'>
						...
						<div class="control-group">
							<label class="control-label col-md-3" for="force_pass_reset"><?php echo lang('set_force_reset'); ?></label>
							<div class="controls">
						...
						<div class="control-group">
							<div class="controls">
                                ...
                                <label class="checkbox" for="do_check">
                                    <input type="checkbox" name="do_check" id="do_check"
                                           value="1" <?php echo $settings['updates.do_check'] == 1 ? 'checked="checked"' : set_checkbox('updates.do_check', 1); ?> />
                                ...
                                <label class="checkbox" for="bleeding_edge">
                                    <input type="checkbox" name="bleeding_edge" id="bleeding_edge"
                                           value="1" <?php echo $settings['updates.bleeding_edge'] == 1 ? 'checked="checked"' : set_checkbox('updates.bleeding_edge', 1); ?> />
					...
					<fieldset>
                        ...
                        foreach ($extended_settings as $field) {
                            if (empty($field['permission'])
                                ...
                                $form_error_class = form_error($field['name']) ? ' has-error' : '';
                                $field_control = '';

                                if ($field['form_detail']['type'] == 'dropdown') {
                                    echo form_dropdown($field['form_detail']['settings'], $field['form_detail']['options'], set_value($field['name'], isset($settings["ext.{$field['name']}"]) ? $settings["ext.{$field['name']}"] : ''), $field['label'],'form-control input-medium');
                                }
                                elseif ($field['form_detail']['type'] == 'checkbox') {
                                    $field_control = form_checkbox($field['form_detail']['settings'], $field['form_detail']['value'],'class=form-control input-medium"', isset($settings["ext.{$field['name']}"]) && $field['form_detail']['value'] == $settings["ext.{$field['name']}"]);
                                }
                                elseif ($field['form_detail']['type'] == 'state_select') {
                                    ...
                                    $field_control = state_select(isset($settings["ext.{$field['name']}"]) ? $settings["ext.{$field['name']}"] : 'CA', 'CA', 'US', $field['name'], 'chzn-select form-control input-medium');
                                }
                                elseif ($field['form_detail']['type'] == 'country_select') {
                                    ...
                                    $field_control = country_select(set_value($field['name'], isset($settings["ext.{$field['name']}"]) ? $settings["ext.{$field['name']}"] : 'US'), 'US', $field['name'], 'chzn-select form-control input-medium');
                                }
                                else {
                                   $field['form_detail']['settings']['class']='form-control input-medium';
                        ...
                        <div class="control-group<?php echo $form_error_class; ?>">
                            <label class="control-label col-md-3" for="<?php echo $field['name']; ?>"><?php echo $field['label']; ?></label>
                            <div class="controls">
                ...
                <?php endif; ?>
                <div class="tab-pane" id="meta-settings">

                    <fieldset>
                        <input type="hidden" name="hidden" value="insert">
                        <legend><?php echo lang('bf_site_meta_information') ?></legend>

                        <div class="control-group">
                            <label class="control-label col-md-3"
                                   for="description"><?php echo lang('bf_site_meta_description') ?></label>

                            <div class="controls">
                <textarea name="description" class="form-control input-large" rows="5"
                          id="description"><?php echo set_value('meta.description', isset($settings['meta.description']) ? $settings['meta.description'] : '') ?></textarea>
                            </div>
                        </div>

                        <div class="control-group ">
                            <label class="control-label col-md-3" for="keyword"><?php echo lang('bf_site_meta_keyword') ?></label>
                ...
                <textarea id="keyword" class="form-control input-large" rows="5"
                          name="keyword"><?php echo set_value('meta.keyword', isset($settings['meta.keyword']) ? $settings['meta.keyword'] : '') ?></textarea>
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label col-md-3" for="favicon"><?php echo lang('bf_site_meta_favicon') ?></label>
                            ...
                            <div class="controls">
                                ...
                                <p>Upload favicon.ico Image.</p>
                            </div>
                            <?php
                            $faviconpath = FCPATH . "favicon.ico";
                            if (file_exists($faviconpath)) {
                                $faviconpath = base_url() . "favicon.ico";
                                ?>
                                <img src="<?php echo $faviconpath; ?>" style="margin-left:208px;margin-top:10px" width="50"
                                     height="50">
                            <?php
                            }
                            ?>
                        ...
                        <div class="control-group">
                            <label class="control-label col-md-3" for="robots"><?php echo lang('bf_site_meta_robots') ?></label>

                            <div class="controls">
                                <input type="file" name="robots" id="robots" class=""
                                       value="<?php //echo set_value('site.title', isset($settings['site.title']) ? $settings['site.title'] : '') ?>"/>

                                <p>Upload robots.txt File.</p>
                            </div>
                            <?php
                            $robotspath = FCPATH . "robots.txt";
                            if (file_exists($robotspath)) {
                                $robotspath = base_url() . "robots.txt";
                                ?>
                                <a href="<?php echo $robotspath; ?>" style="margin-left:208px"
                        ...
                        <div class="control-group">
                            <label class="control-label col-md-3" for="xml"><?php echo lang('bf_site_meta_map_xml') ?></label>

                            <div class="controls">
                                <input type="file" name="xml" id="xml" class=""
                                       value="<?php //echo set_value('site.title', isset($settings['site.title']) ? $settings['site.title'] : '') ?>"/><br/>

                                <p>Upload sitemap.xml File.</p>

                            </div>
                            <?php
                            $robotspath = FCPATH . "sitemap.xml";
                            if (file_exists($robotspath)) {
                                $robotspath = base_url() . "sitemap.xml";
                                ?>
                                <a href="<?php echo $robotspath; ?>" style="margin-left:208px"
                                   target="_blank">sitemap.xml</a>
                            <?php
                            }
                            ?>
                        ...
                        <div class="control-group">
                            <label class="control-label col-md-3" for="htmlfile"><?php echo lang('bf_site_meta_map_html') ?></label>

                            <div class="controls">
                                <input type="file" name="htmlfile" id="htmlfile" class=""
                                       value="<?php echo set_value('site.title', isset($settings['site.title']) ? $settings['site.title'] : '') ?>"/>

                                <p>Upload sitemap.html File.</p>

                            </div>
                            <?php
                            $robotspath = FCPATH . "sitemap.html";
                            if (file_exists($robotspath)) {
                                $robotspath = base_url() . "sitemap.html";
                                ?>
                                <a href="<?php echo $robotspath; ?>" style="margin-left:208px"
                                   target="_blank">sitemap.html</a>
                            <?php
                            }
                            ?>
                ...
                <!--End Meta Setting by chirag prajapati--->
                <!-----Start: Add Footer Script code by chiragprajapti----->
                <div class="tab-pane" id="footer-script">

                    <fieldset>
                        <div class="control-group">
                            <?php
                            //var_dump($settings);
                            if (isset($settings['site_footerscript']) && !empty($settings['site_footerscript'])) {
                                $data = html_entity_decode($settings['site_footerscript']);
                            } else {
                                $data = '';
                            }
                            ?>
                            <label class="control-label col-md-3" for="footerscript">Site Footer Script</label>

                            <div class="controls">
                                <!--					<input type="text" name="title" id="title" class="span6" value="<?php // echo set_value('site.title', isset($settings['site.title']) ? $settings['site.title'] : '') ?>" />-->
                <textarea style="width:80%;height:100px;" id="footerscript"  class="form-control input-large" rows="5"
                          name="footerscript"><?php echo set_value('site_footerscript', isset($settings['site_footerscript']) ? $data : '') ?></textarea>
                            </div>
                        </div>
                    </fieldset>

                </div>
                <!-----End: Add Footer Script code by chiragprajapti----->
                <!-----Start: Add Header Script code by by----->
                <div class="tab-pane" id="header-script">

                    <fieldset>
                        <div class="control-group">
                            <?php
                            //var_dump($settings);
                            if (isset($settings['site_headerscript']) && !empty($settings['site_headerscript'])) {
                                $data = html_entity_decode($settings['site_headerscript']);
                            } else {
                                $data = '';
                            }
                            ?>
                            <label class="control-label col-md-3" for="headerscript">Site Header Script</label>

                            <div class="controls">
                    <textarea style="width:80%;height:100px;" id="headerscript" class="form-control input-large" rows="5"
                              name="headerscript"><?php echo set_value('site_headerscript', isset($settings['site_headerscript']) ? $data : '') ?></textarea>
                            </div>
                        </div>
                    </fieldset>
		...
		<fieldset class="form-actions">
			<input type="submit" name="save" class="btn green" value="<?php echo lang('bf_action_save') . ' ' . lang('bf_context_settings'); ?>" />
		</fieldset>
	<?php echo form_close(); ?>
</div><!-- /admin-box -->