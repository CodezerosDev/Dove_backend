...
class Modulebuilder
{
    ...
    public function __construct()
    {
        ...
        //Grid Area
        $config = array(
            'table'     => $this->CI->input->post('table_name'),
        );
        $this->CI->load->library('CH_Grid_generator', $config, 'grid');
    }
...
//end sachin
    ...
    private function buildView($data)
    {
        ...
        $data['use_status'] = $this->CI->input->post('use_status');
        $data['use_position'] = $this->CI->input->post('use_position');
