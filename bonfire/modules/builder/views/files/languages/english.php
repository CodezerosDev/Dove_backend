...
" . PHP_EOL . "
\$lang['{$module_name_lower}_manage']      = 'Manage {$module_label}';
...
\$lang['{$module_name_lower}_delete_record']   = 'Delete this {$module_label}';
...
// Create/Edit Buttons
\$lang['{$module_name_lower}_action_edit']   = 'Save {$module_label}';
\$lang['{$module_name_lower}_action_create']   = 'Create {$module_label}';
