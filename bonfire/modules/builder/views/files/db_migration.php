...
{
    $status_field = ($this->input->post('status_field')) ? $this->input->post('status_field') : 'status';
    $migrationFields .= "
			'".$status_field."' => array(
				'type' => 'TINYINT',
				'default' => 1,
...
{
    $position_field = ($this->input->post('position_field')) ? $this->input->post('position_field') : 'position';
    $migrationFields .= "
