...
<div class='module-builder'>
    ...
    <div class="admin-box  portlet box green ">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-pencil"></i> Create Module
            </div>
        </div>
        ...
        ?>
            <fieldset id="module_details">
                ...
                <div class="control-group<?php echo form_error('module_name') ? ' has-error' : ''; ?>">
                    <label for="module_name" class="control-label col-md-3 block"><?php echo lang('mb_form_mod_name'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced<?php echo form_error('module_description') ? ' has-error' : ''; ?>">
                    <label for="module_description" class="control-label col-md-3 block"><?php echo lang('mb_form_mod_desc'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced">
                    <label class="control-label col-md-3 block" id="contexts_label"><?php echo lang('mb_form_contexts'); ?></label>
                ...
                <div class="control-group mb_advanced<?php echo form_error('form_action') ? ' has-error' : ''; ?>">
                    ...
                    <label class="control-label col-md-3" id="form_action_label"><?php echo lang('mb_form_actions'); ?></label>
                ...
                <div class="control-group mb_advanced">
                    <label class="control-label col-md-3" for="role_id"><?php echo lang('mb_form_role_id'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class='control-label col-md-3' for='mb_module_db'><?php echo lang('mb_module_db'); ?></label>
            ...
            <fieldset id="db_details">
                ...
                <div class="control-group mb_advanced<?php echo form_error('table_name') ? ' has-error' : ''; ?>">
                    <label for="table_name" class="control-label col-md-3 block"><?php echo lang('mb_form_table_name'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced<?php echo form_error('form_error_delimiters') ? ' has-error' : ''; ?>">
                    <label for="form_error_delimiters" class="control-label col-md-3 block"><?php echo lang('mb_form_err_delims'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced">
                    <label for="textarea_editor" class="control-label col-md-3  block"><?php echo lang('mb_form_text_ed'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced<?php echo form_error('soft_delete_field') ? ' has-error' : ''; ?>">
                    <label for="soft_delete_field" class="control-label col-md-3  block"><?php echo lang('mb_soft_delete_field'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced<?php echo form_error('deleted_by_field') ? ' has-error' : ''; ?>">
                    <label for="deleted_by_field"  class="control-label col-md-3 block"><?php echo lang('mb_deleted_by_field'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced<?php echo form_error('created_field') ? ' has-error' : ''; ?>">
                    <label for="created_field" class="control-label col-md-3 block"><?php echo lang('mb_form_created_field'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced<?php echo form_error('created_by_field') ? ' has-error' : ''; ?>">
                    <label for="created_by_field" class="control-label col-md-3 block"><?php echo lang('mb_form_created_by_field'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced<?php echo form_error('modified_field') ? ' has-error' : ''; ?>">
                    <label for="modified_field" class="control-label col-md-3 block"><?php echo lang('mb_form_modified_field'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced<?php echo form_error('modified_by_field') ? ' has-error' : ''; ?>">
                    <label for="modified_by_field" class="control-label col-md-3 block"><?php echo lang('mb_form_modified_by_field'); ?></label>
                    <div class="controls">
                ...
                ?>
                <div class="control-group mb_advanced">
                    <label for="use_status" class="control-label col-md-3 block"><?php echo lang('mb_form_use_status'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced <?php echo form_error('status_field') ? 'has-error' : ''; ?>">
                    <label for="status_field" class="control-label col-md-3 block"><?php echo lang('mb_form_status_field'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced">
                    <label for="use_position" class="control-label col-md-3 block"><?php echo lang('mb_form_use_position'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_advanced <?php echo form_error('position_field') ? 'has-error' : ''; ?>">
                    <label for="position_field" class="control-label col-md-3 block"><?php echo lang('mb_form_position_field'); ?></label>
                    <div class="controls">
                ...
                <div class="control-group mb_new_table<?php echo form_error('primary_key_field') ? ' has-error' : ''; ?>">
                    <label for="primary_key_field" class="control-label col-md-3 block"><?php echo lang('mb_form_primarykey'); ?></label>
                    <div class="controls">
                ...
                <div id="field_numbers" class="control-group">
                    <label class="control-label col-md-3"><?php echo lang('mb_form_fieldnum'); ?></label>
                    <div class="controls">
                        <?php
            ...
            <div id="all_fields">
                ...
                <fieldset id="field<?php echo $count; ?>_details">
                    ...
                    <div class="control-group<?php echo form_error($viewFieldLabel) ? ' has-error' : ''; ?>">
                        <label class="control-label col-md-3" for="<?php echo $viewFieldLabel; ?>"><?php echo lang('mb_form_label'); ?></label>
                        <div class="controls">
                    ...
                    <div class="control-group<?php echo form_error($viewFieldName) ? ' has-error' : ''; ?>">
                        <label class="control-label col-md-3" for="<?php echo $viewFieldName; ?>"><?php echo lang('mb_form_fieldname'); ?></label>
                        <div class="controls">
...
//                        elseif (in_array($existing_table_fields[$count]['type'], $textFieldTypes)) {
//                            $default_field_type = 'file';
//                        }
                    }
                    ...
                    <div class="control-group <?php echo form_error($dbFieldLength) ? 'has-error' : ''; ?>">
                        <label class="control-label col-md-3" for="<?php echo $dbFieldLength; ?>"><?php echo lang('mb_form_length'); ?></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label col-md-3" id="<?php echo $validationLbl; ?>"><?php echo lang('mb_form_rules'); ?></label>
                        <div class="controls" aria-labelledby="<?php echo $validationLbl; ?>" role="group">
                            ...
                            ?>
                            <span class="faded">
                                <label class="checkbox" for="<?php echo $validationRulesRuleCount; ?>">
                    ...
                    <div class="control-group mb_advanced">
                        <label class="control-label col-md-3" id="<?php echo $validLimitLbl; ?>"><?php echo lang('mb_form_rules_limits'); ?></label>
                        <div class="controls" aria-labelledby="<?php echo $validLimitLbl; ?>" role="group">
                            ...
                            ?>
                            <span class="faded">
                                <label class="radio col-md-2" for="<?php echo $validationRulesLimitCount; ?>">
                    ...
                    <div style="margin-left: 10px;">
                        ...
                        <div class="control-group">
                            <label class="control-label col-md-3" for=""><?php echo lang('grid_form_search_label'); ?></label>
                            <div class="controls">
                                <input name="grid_search[]" type="checkbox" value="view_field_name<?php echo $count; ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label col-md-3" for=""><?php echo lang('grid_form_sort_label'); ?></label>
                            <div class="controls">
                                <input name="grid_sort[]" type="checkbox" value="view_field_name<?php echo $count; ?>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label col-md-3" for=""><?php echo lang('grid_form_between_label'); ?></label>
                            <div class="controls">
